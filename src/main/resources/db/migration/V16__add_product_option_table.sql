...
INSERT INTO product_options (product_id, color, size, additional_price, stock, stock_status) VALUES
    (1, '빨강', 'S', 0, 10, 'IN_STOCK'),
    (1, '빨강', 'M', 0, 15, 'IN_STOCK'),
    (1, '빨강', 'L', 1000, 8, 'IN_STOCK'),
    (1, '빨강', 'XL', 2000, 3, 'LOW_STOCK'),
    (1, '파랑', 'S', 0, 20, 'IN_STOCK'),
    (1, '파랑', 'M', 0, 12, 'IN_STOCK'),
    (1, '파랑', 'L', 1000, 5, 'LOW_STOCK'),
    (1, '파랑', 'XL', 2000, 0, 'OUT_OF_STOCK'),
    (1, '검정', 'S', 500, 18, 'IN_STOCK'),
    (1, '검정', 'M', 500, 25, 'IN_STOCK'),
    (1, '검정', 'L', 1500, 7, 'IN_STOCK'),
    (1, '검정', 'XL', 2500, 2, 'LOW_STOCK');